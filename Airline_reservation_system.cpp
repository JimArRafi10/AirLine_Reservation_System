...
class BOOKING
{
    ...
    public :
        int getInfo()
        {
            ...
            cout << "Enter Birth Identity Number :- ";
            cin >> aidentity;
            ...
            do
            {
                ...
                {
                    case 1:
                        strcpy(departure, "DHAKA");
                        break;
                    case 2:
                        strcpy(departure, "SHYLET");
                        break;
                    case 3:
                        strcpy(departure, "SAIDPUR");
                        break;
                    case 4:
                        strcpy(departure, "CHITTAGONG");
                        break;
                    case 5:
                        strcpy(departure, "BARISHAL");
                        break;
                    case 6:
                        strcpy(departure, "JASHORE");
                        break;
                    default:
            ...
            do
            {
                ...
                switch(n)
                {
                    case 1:
                        ...
                        break;
                    case 2:
                        strcpy(arrival,"SHYLET");
                        break;
                    case 3:
                        strcpy(arrival,"SAIDPUR");
                        break;
                    case 4:
                        strcpy(arrival,"CHITTAGONG");
                        break;
                    case 5:
                        strcpy(arrival,"BARISHAL");
                        break;
                    case 6:
                        strcpy(arrival,"JASHORE");
                        break;
                   default:
                        cout << "Invalid choice . Please Try Again.\n";
                        p++;
        ...
        {
            cout.setf(ios::left);
            cout <<setw(15)<< name <<setw(12)<< date <<setw(20)<< add <<setw(15)<< mobile <<setw(30)<<email<<setw(20)<<aidentity<<setw(12)<< departure <<setw(12)<< arrival<<endl;
        }
        ...
        case 3:
            {
                ...
                cout <<"\t1. By Name\n\t2. By Email\n";
                cout <<"\t3. By Birth Identity Number(Recommended)\n\t4. By Phone Number\n";
                ...
                switch (choice)
                {
                    ...
                    case 3:
                        {
                            int flag = 0;
                            cout << "Enter the Identity number which you want to search :- ";
                            cin >> sIdentity;
                            ...
                            cout.setf(ios::left);
                            cout <<setw(15)<<"Name"<<setw(12)<<"Date"<<setw(20)<<"Address"<<setw(15)<<"Mobile"<<setw(30)<<"Email"<<setw(20)<<"Birth Identity"<<setw(12)<<"Depart."<<setw(12)<<"Arrival"<<endl;
                            cout <<setw(15)<<"----"<<setw(12)<<"----"<<setw(20)<<"-------"<<setw(15)<<"------"<<setw(30)<<"-----"<<setw(20)<<"------"<<setw(12)<<"-------"<<setw(12)<<"-------"<<endl;

                            while (f3.eof() != 1)
                            {
                                if(sIdentity == s.aidentity)
                                {
                                    s.disInfo();
                                    flag = 1;
                                }
